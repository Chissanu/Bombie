...
public class PlayerController : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        for (int i = 0; i < maxBombs; i++)
        {
            ...
            newBomb.GetComponent<Renderer>().enabled = false;
    ...
    void Attack()
    {
        ...
        bombList[currentBomb].GetComponent<Rigidbody>().velocity = Vector3.zero;
        bombList[currentBomb].transform.position = currentPos;
        currentBomb++;
